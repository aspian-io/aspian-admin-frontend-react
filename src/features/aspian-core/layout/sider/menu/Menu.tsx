...
const AspianMenu = () => {
  return (
    <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
      <Menu.Item
        className="dashboard__menu-logo"
        disabled
      >
      ...
      <Menu.Item key="1" icon={<DashboardOutlined className="dashboard__menu-icon" />}>
        Dashboard
      </Menu.Item>
      <SubMenu key="sub1" icon={<PushpinOutlined className="dashboard__menu-icon" />} title="Posts">
      ...
      <SubMenu key="sub2" icon={<CloudServerOutlined className="dashboard__menu-icon" />} title="Media">
        <Menu.Item key="6">Library</Menu.Item>
        <Menu.Item key="7">Add New</Menu.Item>
      </SubMenu>
      <SubMenu key="sub3" icon={<DiffOutlined className="dashboard__menu-icon" />} title="Pages">
        <Menu.Item key="8">All Pages</Menu.Item>
        <Menu.Item key="9">Add New</Menu.Item>
      </SubMenu>
      <Menu.Item key="10" icon={<CommentOutlined className="dashboard__menu-icon" />}>
        Comments
      </Menu.Item>
      <SubMenu key="sub4" icon={<FormatPainterOutlined className="dashboard__menu-icon" />} title="Appearance">
        <Menu.Item key="11">Customize</Menu.Item>
        <Menu.Item key="12">Menus</Menu.Item>
      </SubMenu>
      <SubMenu key="sub5" icon={<TeamOutlined className="dashboard__menu-icon" />} title="Users">
        <Menu.Item key="13">All Users</Menu.Item>
        <Menu.Item key="14">Add New</Menu.Item>
        <Menu.Item key="15">Your Profile</Menu.Item>
      </SubMenu>
      <SubMenu key="sub6" icon={<ControlOutlined className="dashboard__menu-icon" />} title="Settings">
