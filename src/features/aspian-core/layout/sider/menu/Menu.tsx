...
const AspianMenu = () => {
  return (
    <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
      ...
      <SubMenu key="sub1" icon={<PushpinOutlined className="menu-icon" />} title="Posts">
      ...
      <SubMenu key="sub2" icon={<CloudServerOutlined className="menu-icon" />} title="Media">
        <Menu.Item key="6">Library</Menu.Item>
        <Menu.Item key="7">Add New</Menu.Item>
      </SubMenu>
      <SubMenu key="sub3" icon={<DiffOutlined className="menu-icon" />} title="Pages">
      ...
      <SubMenu key="sub4" icon={<FormatPainterOutlined className="menu-icon" />} title="Appearance">
        <Menu.Item key="11">Customize</Menu.Item>
        <Menu.Item key="12">Menus</Menu.Item>
      </SubMenu>
      <SubMenu key="sub5" icon={<TeamOutlined className="menu-icon" />} title="Users">
        <Menu.Item key="13">All Users</Menu.Item>
        <Menu.Item key="14">Add New</Menu.Item>
        <Menu.Item key="15">Your Profile</Menu.Item>
      </SubMenu>
      <SubMenu key="sub6" icon={<ControlOutlined className="menu-icon" />} title="Settings">
