...
import '../../../scss/components/uppy/_uppy-custom.scss';
import '../../../scss/components/uppy/_uppy-rtl.scss';
import '../../../scss/components/uppy/_uppy-fa.scss';
...
import {IAttachmentUploadSettings} from "../../../app/models/attachment";
import {IPostInitFormValues, PostVisibilityEnum} from "../../../app/models/post";
...
const Attachments: FC<IAttachmentsProps> = ({
    ...
    return (
        <Fragment>
            {postInitFormValues.visibility === PostVisibilityEnum.Private &&
            <Dashboard
                uppy={uppy}
                height={350}
            ...
            {postInitFormValues.visibility === PostVisibilityEnum.Public &&
            <Dashboard
                uppy={uppyPublic}
                height={350}
                showRemoveButtonAfterComplete={false}
