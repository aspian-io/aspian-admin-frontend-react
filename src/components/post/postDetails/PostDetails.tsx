...
import {GetRoundedFileSize} from '../../../js-ts/base/FileSize';
import {v4 as uuidv4} from 'uuid';
import {UAParser} from 'ua-parser-js';
import {history} from '../../../index';
import '../../../scss/pages/posts/post-details/_post-details.scss';
import agent from '../../../app/api/aspian-core/agent';
import GetRandomColor from '../../../js-ts/base/GetRandomColor';
...
import {deletePost, getPost, LanguageActionTypeEnum, clearPostState} from "../../../app/store/actions";
import SanitizeHTML from "../../infrastructure/security/SanitizeHTML";
...
type PostDetailsProps = RouteComponentProps<DetailParams> & IPostDetailsProps;
...
const PostDetails: FC<PostDetailsProps> = ({
    ...
    }, [clearPostState, getPost, match.params.id]);
        ...
        <PageHeader
            ...
            extra={[
                <Button
                    ...
                    type="primary"
                    icon={<EditFilled/>}
                    onClick={() => history.push(`/admin/posts/edit/${post.id}`)}
                >
                    {t('buttons.edit')}
                </Button>,
                <Popconfirm
                                        ...
                                        <Fragment key={uuidv4()}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {value.attachment?.publicFileName}
                                                    </a>
                                                </Descriptions.Item>
                                                <Descriptions.Item
...
// Redux State To Map
const mapStateToProps = ({post, locale}: IStoreState): { post: IPost | null, submitting: boolean, loadingInitial: boolean, lang: LanguageActionTypeEnum } => {
    return {
        post: post.post,
